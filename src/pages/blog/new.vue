...
<template>
  ...
  >
    <div class="flex  flex-col items-center justify-center">
      ...
      <div class="w-full">
        <component :is="components[currentComponent]" @blogUpdated="blogUpdated" @videoUpdated="videoUpdated" @updateExistingBlog="updateExistingBlog" :blogId="blogId" :sourceVideo="source"></component>
      </div>
    </div>
  </div>
</template>
